...
public class Main2_var2 {
    ...
    static String dev(String[] a) throws Exception {
        int ca;
        int cb;
        int otvet;
        String otvet1;
        ...
        if (a.length != 3) {
            return "Не соответстует требованиям (строка 139)";
        }
        if ((a[0].equals("0") || a[0].equals("1") || a[0].equals("2") || a[0].equals("3") || a[0].equals("4") || a[0].equals("5") || a[0].equals("6") || a[0].equals("7") || a[0].equals("8") || a[0].equals("9") || a[0].equals("10")) && (a[2].equals("0") || a[2].equals("1") || a[2].equals("2") || a[2].equals("3") || a[2].equals("4") || a[2].equals("5") || a[2].equals("6") || a[2].equals("7") || a[2].equals("8") || a[2].equals("9") || a[2].equals("10")) ) {
            ...
            if ((a[0] == "I" || a[0].equals("II") || a[0].equals("III") || a[0].equals("IV") || a[0].equals("V") || a[0].equals("VI") || a[0].equals("VII") || a[0].equals("VIII") || a[0].equals("IX") || a[0].equals("X")) && (a[2].equals("I") || a[2].equals("II") || a[2].equals("III") || a[2].equals("IV") || a[2].equals("V") || a[2].equals("VI") || a[2].equals("VII") || a[2].equals("VIII") || a[2].equals("IX") || a[2].equals("X"))) {
